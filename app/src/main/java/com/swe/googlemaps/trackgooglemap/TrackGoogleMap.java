package com.swe.googlemaps.trackgooglemap;
...
public class TrackGoogleMap extends AppCompatActivity {
    //Initialize variable
    ...
    private void DisplayTrack(String sSource, String sDestination) {
        //If the device doesn't have a map installed, then redirect it to play store
        try {
